...
def create_table(eula_frame):
    ...
    table = [
        ...
        ["CyberArk Software, Inc.",	"60 Wells Avenue,\nNewton, MA 02459, U.S.A.",	"Laws of Commonwealth of Massachusetts, U.S.A.","Courts of Boston, Massachusetts, U.S.A."],
        ...
        ["CyberArk Software (Australia) Pty Ltd", "Suite 6.0.1, Level 6, 55 Clarence St. Sydney NSW 2000", "Laws of Victoria, Australia", "Courts of Melbourne, Australia"]
    ]
...
def create_eula():
    ...
    #create main frame
    eula_frame = tk.Frame(eula_window)
    eula_frame.pack(fill=tk.BOTH, expand=1)
    
    # create canvas
    canvas = tk.Canvas(eula_frame, height=500)
    canvas.pack(side=tk.LEFT, fill=tk.BOTH, expand=1)

    # add scroll bar to canvas
    eula_scrollbar = tk.Scrollbar(eula_frame, orient=tk.VERTICAL, command=canvas.yview)
